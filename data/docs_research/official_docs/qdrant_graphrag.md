...
Time: 30 minLevel: IntermediateOutput: GitHub
...
This tutorial will demonstrate how to build a GraphRAG system with vector search using Neo4j and Qdrant.Additional MaterialsThis advanced tutorial is based on our original integration doc: Neo4j - Qdrant IntegrationThe output for this tutorial is in our GitHub Examples repo: Neo4j - Qdrant Agent in Python
## Watch the Video
...
Graph Fetching:
- eo4j_driver` connects to Neo4j for querying graph data.
