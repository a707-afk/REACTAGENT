<!-- source: FlagEmbedding Dense+Sparse+Colbert -->
...
- 09/12/2023: New models:
 ...
 - **update embedding model**: release ge-*-v1.5` embedding model to alleviate the issue of the similarity distribution, and enhance its retrieval ability without instruction.
...
ge` is short for `BAAI general embedding`.
...
| [BAAI/bge-base-en](https://huggingface.co/BAAI/bge-base-en) | English | a base-scale model but with similar ability to ge-large-en` | `Represent this sentence for searching relevant passages: ` |
...
| [BAAI/bge-base-zh](https://huggingface.co/BAAI/bge-base-zh) | Chinese | a base-scale model but with similar ability to ge-large-zh` | `为这个句子生成表示以用于检索相关文章：` |
