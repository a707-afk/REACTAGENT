...
With Qdrant, you have full control of how indexing works. You can disable indexing by setting the HNSW `m` parameter to `:
...
Now upload the vectors, with atch_size=8`. We do not have many documents, but batching is always recommended.
