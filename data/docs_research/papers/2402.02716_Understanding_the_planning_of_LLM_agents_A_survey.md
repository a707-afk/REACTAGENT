...
**arXiv ID**: 2402.02716v1
**Authors**: Xu Huang, Weiwen Liu, Xiaolong Chen, Xingmei Wang, Hao Wang
...
Defu Lian1111Defu Lian is the corresponding author.
...
2Huawei Noah’s Ark Lab, Shenzhen, China
{xuhuangcs, chenxiaolong, xingmeiwang}@mail.ustc.edu.cn,
{haowang, liandefu, cheneh}@ustc.edu.cn,
...
Despite the abstract concept of planning, a general formulation of the planning tasks can be described as follows. Given time step ` , with the environment denoted as `E` , the action space as `A` , the task goal as `g` , and the action at step ` as _{t}\in A` , the planning procedure can be expressed as the generation of a sequence of actions:
[table]
...
*[Figure: Table 1: A taxonomy for existing LLM-Agent planning works.]*
...
Retrieval Augmented Generation (RAG) Lewis et al. (2020); Mao et al. (2020); Cai et al. (2022) techniques are proposed to aid text generation with retrieved information. It is capable of enhancing the LLM with the latest knowledge, such as New Bing333https://www.bing.com/ and Google Bard444https://bard.google.com. For LLM agents, past experiences could be stored in the memory and retrieved when needed. The core idea of such methods is to retrieve task-relevant experiences from the memory during task planning. Among those methods, memories are typically stored in additional storage, and the forms are diverse, such as texts Park et al. (2023); Liu et al. (2023b); Packer et al. (2023); Wang et al. (2023c); Zhong et al. (2023), tabular forms Zhang et al. (2023a), knowledge graph Pan et al. (2024), etc.
...
*[Figure: Table 2: Evaluation of representative prompt-based methods on four interactive benchmarks. The SR, AR and EX are abbreviations of success rate, averag]*
...
Constructions Aeronautiques, Adele Howe, et al.
...
In SIGIR, pages 3417–3419, 2022.


Chen et al. [2021a]

Lili Chen, Kevin Lu, et al.


Decision transformer: Reinforcement learning via sequence modeling.


NeurIPS, 34:15084–15097, 2021.
...
In Aips, volume 2, pages 281–290, 2002.


Ghallab et al. [2004]

Malik Ghallab, Dana Nau, et al.
...
Lin Guan, Karthik Valmeekam, et al.
...
Patrik Haslum, Nir Lipovetzky, et al.
...
Takeshi Kojima, Shixiang Shane Gu, et al.
...
Bill Yuchen Lin, Yicheng Fu, et al.
...
Nir Lipovetzky, Miquel Ramirez, et al.
...
Aman Madaan, Niket Tandon, , et al.
...
Yuning Mao, Pengcheng He, Liu, et al.
...
Joon Sung Park, Joseph O’Brien, et al.


Generative agents: Interactive simulacra of human behavior.


In SUIST, pages 1–22, 2023.


Qin et al. [2023]

Yujia Qin, Shengding Hu, et al.
...
Jan Maarten Schraagen, Susan F Chipman, et al.
...
Yongliang Shen, Kaitao Song, et al.
...
Mohit Shridhar, Xingdi Yuan, et al.
...
Ishika Singh, Valts Blukis, et al.


Progprompt: Generating situated robot task plans using large language models.


In ICRA 2023, pages 11523–11530. IEEE, 2023.


Sun et al. [2023]

Jiankai Sun, Chuanyang Zheng, et al.
...
James Thorne, Andreas Vlachos, et al.
...
Ruoyao Wang, Peter Jansen, et al.
...
Yancheng Wang, Ziyan Jiang, et al.
...
Chenfei Wu, Shengming Yin, et al.
...
arXiv preprint arXiv:2312.01797, 2023.


Yang et al. [2018]

Zhilin Yang, Peng Qi, et al.
