<!-- source: smolagents.md official README -->
<!-- url: https://raw.githubusercontent.com/huggingface/smolagents/main/README.md -->
<!-- fetched: 2026-06-14 -->
...
🌐 **Model-agnostic**: smolagents supports any LLM. It can be a local ransformers` or `ollama` model, one of [many providers on the Hub](https://huggingface.co/blog/inference-providers), or any model from OpenAI, Anthropic and many others via our [LiteLLM](https://www.litellm.ai/) integration.
...
<details>
<summary> <b>Local ransformers` model</b></summary>
...
We strived to keep abstractions to a strict minimum: the main code in gents.py` has <1,000 lines of code.
