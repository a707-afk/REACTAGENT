<!-- source: pydantic_ai.md official README -->
<!-- url: https://raw.githubusercontent.com/pydantic/pydantic-ai/main/README.md -->
<!-- fetched: 2026-06-14 -->
...
# The ool` decorator let you register functions which the LLM may call while responding to a user.
...
async def main():
 ...
 # The esult.output` will be validated with Pydantic to guarantee it is a `SupportOutput`. Since the agent is generic,
