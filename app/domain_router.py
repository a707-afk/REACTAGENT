...
_DOMAIN_KEYWORDS: dict[str, tuple[str, ...]] = {
    ...
    "tech_support": ("error", "bug", "crash", "not working", "崩溃", "报错", "闪退", "打不开", "driver", "驱动", "update", "更新",
                    "firmware", "固件", "connectivity", "connection", "连接", "vpn", "VPN", "troubleshoot", "排查", "故障"),
    "billing": ("invoice", "发票", "charge", "charged", "收费", "扣费", "扣款", "payment", "支付", "付款", "billing", "billed", "账单",
               "credit card", "信用卡", "subscription", "订阅", "overcharge", "多扣", "price", "pricing", "价格", "费用"),
    "account": ("login", "登录", "password", "密码", "credential", "凭证", "reset", "重置", "sign in", "登入", "unlock", "解锁",
               "recover account", "找回账号", "create account", "注册", "delete account", "注销", "销户", "profile", "个人资料"),
    "order": ("order", "订单", "purchase", "购买", "cancel order", "取消订单", "cancel purchase", "cart", "购物车",
             "checkout", "结账", "track order", "查订单", "order number", "订单号"),
    "returns": ("return", "退货", "refund", "退款", "exchange", "换货", "refund policy", "退款政策", "warranty", "保修",
               "money back", "退钱", "return shipping", "退货运费"),
    "delivery": ("shipping", "发货", "delivery", "配送", "快递", "tracking", "物流", "package", "包裹", "delivered", "已送达",
               "not received", "没收到", "lost package", "丢件", "delivery address", "收货地址"),
    "outages": ("down", "宕机", "挂了", "outage", "故障", "offline", "离线", "disruption", "中断", "not accessible", "无法访问",
              "service disruption", "服务中断", "maintenance", "维护", "degradation", "降级"),
    "sales": ("pricing", "报价", "quote", "询价", "enterprise", "企业版", "discount", "折扣", "license", "许可证",
            "demo", "演示", "trial", "试用", "sales inquiry", "销售咨询", "procurement", "采购"),
    "feedback": ("complaint", "投诉", "feedback", "反馈", "review", "评价", "unhappy", "不满", "dissatisfied", "不满意",
               "suggestion", "建议", "newsletter", "退订", "unsubscribe"),
    "hr": ("onboarding", "入职", "employee", "员工", "benefits", "福利", "payroll", "工资", "leave", "请假", "休假",
          "hr issue", "HR问题", "termination", "离职", "new hire", "新人"),
    "it_support": ("workstation", "工作站", "laptop", "笔记本", "printer", "打印机", "projector", "投影仪", "asset", "资产",
                 "office", "办公", "license activation", "激活", "deploy", "部署", "software install", "安装软件"),
    "product_support": ("setup", "设置", "install", "安装", "configuration", "配置", "compatibility", "兼容性",
                      "feature", "功能", "how to use", "怎么用", "使用说明", "user manual", "手册"),
    "general": ("generic", "miscellaneous", "其他", "一般"),
}
