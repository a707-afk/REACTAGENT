"""Agent API — unified Harness only. LangGraph path removed. """  # noqa: D205
...
async def agent_ticket(req: TicketAgentRequest, request: Request) -> TicketAgentResponse:
    """Process a ticket through the unified Agent Harness.

    All /agent/ticket requests now go through the Harness. The legacy
    LangGraph path was removed in the enterprise rebuild.
    """
